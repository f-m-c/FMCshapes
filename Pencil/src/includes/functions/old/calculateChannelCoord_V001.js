...
//
    ...
    if (isHorizontal) {
        ...
        lae2y = cy ;
        rx = cx - 4.5 - xdir*(directionType == 'single' ? 5 : 0); 
        ry = cy - rOff + 4;
        ras1x = cx - xdir*11;
        ras1y = cy - rOff;
        ras2x = cx - xdir*17;
        ras2y = cy - rOff;
        rae1x = cx + xdir*(11 + (directionType == 'bidirectional' ? 0 : -4));
        rae1y = cy - rOff;
        rae2x = cx + xdir*(17 + (directionType == 'bidirectional' ? 0 : -4));
        rae2y = cy - rOff;
    } else {
        ...
        rx = cx + rOff - 4.5;
        ry = cy + 4 + ydir*(directionType == 'single' ? -5 : 0);
        ras1x = cx + rOff; 
        ras1y = cy - ydir*12;
        ras2x = cx + rOff; 
        ras2y = cy - ydir*18;
        rae1x = cx + rOff; 
        rae1y = cy + ydir*(12 + (directionType == 'bidirectional' ? 0 : -4));
        rae2x = cx + rOff; 
        rae2y = cy + ydir*(18 + (directionType == 'bidirectional' ? 0 : -4));
    }
    return {
        cx: cx, cy: cy,
